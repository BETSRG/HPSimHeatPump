...
CHARACTER(LEN=23),PARAMETER :: FMT_2209 = "(A33,',',F40.5,',',A15)"
...
CoilSurfTemp=CoilParams(2)%TSurfCoil*9/5+32 !RS Comment: Unit Conversion, from C to F
  ...
  WRITE(5,FMT_2209)'Evaporator Air Humidity Ratio    ',EvapOUT%AirHumRat,'' !RS: Debugging: Setting to pass out the exiting air humidity ratio in the output file (10/29/14)
  WRITE(5,FMT_2209)'Compressor Input Ratio           ',inputratio,'' !RS: Debugging: Setting to pass out the compressor ratio (11/15/14)
  WRITE(5,*)
