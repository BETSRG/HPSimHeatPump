...
USE DataGlobals, ONLY: MaxNameLength !, ShowContinueError ShowFatalError, ShowWarningError, ShowSevereError
...
SUBROUTINE GetFluidPropertiesData
  ...
  REAL(r64), DIMENSION(251) :: TmpNumbers
