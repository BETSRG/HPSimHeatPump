...
USE InputProcessor
USE DataGlobals ,   ONLY : MaxNameLength !, ShowSevereError, ShowWarningError, ShowContinueError
...
USE DataGlobals, ONLY: DoOutputReporting, KindOfSim, ksRunPeriodWeather !, ShowFatalError
