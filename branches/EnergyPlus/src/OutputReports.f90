SUBROUTINE ReportSurfaces
  ...
  USE DataGlobals, ONLY: MaxNameLength !, ShowWarningError
...
SUBROUTINE LinesOut(option)
  ...
  USE DataHeatBalance
  USE DataSurfaces
!  USE DataGlobals, ONLY: ShowWarningError, ShowContinueError, ShowFatalError
...
SUBROUTINE DXFOut(PolygonAction,ColorScheme)
  ...
  USE DataGlobals, ONLY: DegToRadians,NumOfZones !,ShowWarningError, ShowContinueError, ShowFatalError
