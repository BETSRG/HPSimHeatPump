...
USE DataLoopNode
USE DataGlobals, ONLY: MaxNameLength !, ShowWarningError, ShowSevereError, ShowFatalError
...
SUBROUTINE SimPlantValves(CompTypeNum,CompName,CompNum,RunFlag,InitLoopEquip,  &
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: BeginEnvrnFlag !, ShowFatalError, ShowContinueError, ShowSevereError
...
SUBROUTINE InitPlantValves(CompTypeNum,CompNum, FirstHVACIteration)
          ...
          ! USE STATEMENTS:
  USE DataGlobals,       ONLY: BeginEnvrnFlag !, ShowSevereError, ShowWarningError, ShowContinueError
