...
SUBROUTINE InitElectricChiller(ChillNum,RunFlag, MyLoad, FirstHVACIteration)
          ...
          ! USE STATEMENTS:
  USE DataGlobals,     ONLY : BeginEnvrnFlag, AnyEnergyManagementSystemInModel !, ShowFatalError, ShowSevereError, ShowContinueError
...
SUBROUTINE CalcConstCOPChillerModel(ChillNum,MyLoad,Runflag,FirstIteration,EquipFlowCtrl)
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: SecInHour, CurrentTime !, ShowWarningError, ShowSevereError, &
