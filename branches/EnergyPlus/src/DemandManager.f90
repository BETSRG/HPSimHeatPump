...
SUBROUTINE ManageDemand
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: WarmupFlag, DoingSizing !, ShowFatalError
...
SUBROUTINE GetDemandManagerListInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: MaxNameLength, MinutesPerTimeStep !, ShowSevereError, &
...
SUBROUTINE GetDemandManagerInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: MaxNameLength, MinutesPerTimeStep !, ShowSevereError, ShowWarningError, &
