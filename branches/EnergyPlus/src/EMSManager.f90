...
USE DataGlobals, ONLY: MaxNameLength !, ShowFatalError, ShowWarningError, ShowContinueError
...
SUBROUTINE InitEMS (iCalledFrom)
          ...
          ! USE STATEMENTS:
  USE DataGlobals, ONLY: WarmupFlag, DoingSizing, KickOffSimulation, BeginEnvrnFlag, emsCallFromZoneSizing, &
...
!  USE DataIPShortcuts, ONLY: cCurrentModuleObject
  ...
  !USE DataGlobals,  ONLY: ShowSevereError, ShowWarningError, ShowContinueError, ShowFatalError
