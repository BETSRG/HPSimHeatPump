SUBROUTINE ControlCompOutput(CompName,CompType,CompNum,FirstHVACIteration,QZnReq, &
  ...
  USE DataLoopNode
  USE DataGlobals,            ONLY : WarmUpFlag !,ShowWarningError,ShowFatalError,ShowContinueError,ShowSevereError
...
SUBROUTINE CheckSysSizing(CompType,CompName)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals, ONLY: DoSystemSizing !, ShowSevereError,ShowContinueError,ShowFatalError
...
SUBROUTINE CheckZoneSizing(CompType,CompName)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals, ONLY: DoZoneSizing !, ShowSevereError,ShowContinueError,ShowFatalError
...
SUBROUTINE TestAirPathIntegrity(ErrFound)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals, ONLY: MaxNameLength, OutputFileBNDetails !, ShowFatalError, ShowWarningError, &
