...
USE DataGenerators
USE DataGlobals, ONLY: MaxNameLength, OutputFileInits, HoursInDay !, ShowWarningError, &
...
MODULE GeneratorDynamicsManager
          ...
          ! USE STATEMENTS:
USE DataGenerators
USE DataGlobals,    ONLY: CurrentTime, DayOfSim, HoursInDay, SecInHour !, ShowFatalError, ShowContinueError
          ! <use statements for access to subroutines in other modules>
