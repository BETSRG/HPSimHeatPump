...
REAL, ALLOCATABLE, DIMENSION(:) :: MoistEMPDOld ! Moisture level at interior surfaces at previous time step
REAL, ALLOCATABLE, DIMENSION(:) :: MoistEMPDInt ! Moisture level at interior surfaces at previous interation
                                                            ! and current time step
REAL, ALLOCATABLE, DIMENSION(:) :: MoistEMPDNew ! Moisture level at interior surfaces at current interation
                                                            ! and current time step
REAL, ALLOCATABLE, DIMENSION(:) :: MoistEMPDFlux ! Moisture flux at interior surfaces [W]
