...
SUBROUTINE GetUserDefinedPatternData(ErrorsFound)
          ...
          ! USE STATEMENTS:
          ! na
  USE DataGlobals,    ONLY: NumOfZones !, ShowMessage
...
SUBROUTINE SharedDVCVUFDataInit(ZoneNum)
  ...
  USE DataSurfaces
  USE DataGlobals,  ONLY : NumOfZones, MaxNameLength !, ShowWarningError, ShowFatalerror, ShowSevereError, ShowContinueError
  USE DataHeatBalance, ONLY : Zone
  USE DataAirflowNetwork
