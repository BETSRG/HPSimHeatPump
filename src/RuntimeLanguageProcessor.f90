...
!  USE DataGlobals, ONLY: ShowSevereError, ShowFatalError, ShowContinueError
...
RECURSIVE FUNCTION EvaluateExpression(ExpressionNum) RESULT(ReturnValue)
  ...
  USE DataGlobals, ONLY: DegToRadians !, ShowFatalError, ShowSevereError, ShowWarningError !unused, TimeStepZone
...
SUBROUTINE GetRuntimeLanguageUserInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals,    ONLY: MaxNameLength, TimeStepZone !, ShowSevereError, ShowWarningError, ShowFatalError, ShowContinueError
