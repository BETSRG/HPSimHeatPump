...
SUBROUTINE SetupTimePointers(IndexKey,TimeStep)
          ...
          ! USE STATEMENTS:
  USE DataGlobals, Only: OutputFileStandard !, ShowSevereError
...
SUBROUTINE UpdateDataandReport(IndexTypeKey)
  ...
  USE DataGlobals, ONLY: HourOfDay, DayOfSimChr, EndHourFlag, EndDayFlag, EndEnvrnFlag, OutputFileStandard
...
SUBROUTINE GenOutputVariablesAuditReport
  ...
  USE DataPrecisionGlobals
  USE OutputProcessor
  USE DataGlobals,    ONLY: DisplayAdvancedReportVariables !, ShowMessage
