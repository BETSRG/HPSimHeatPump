...
USE DataGlobals,       ONLY : MaxNameLength, BeginTimeStepFlag, SysSizingCalc !, ShowWarningError, ShowSevereError, &
...
SUBROUTINE DistributeHTRadGains
          ...
          ! USE STATEMENTS:
  USE DataGlobals,       ONLY : NumOfZones !, ShowSevereError, ShowFatalError, &
