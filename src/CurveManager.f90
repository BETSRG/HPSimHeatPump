...
USE DataGlobals,    ONLY: MaxNameLength, AnyEnergyManagementSystemInModel !, ShowSevereError, ShowWarningError, ShowFatalError, ShowContinueError
...
REAL FUNCTION CurveValue(CurveIndex,Var1,Var2,Var3, Var4, Var5)
          ...
          ! USE STATEMENTS:
  USE DataGlobals,    ONLY: BeginEnvrnFlag !, ShowFatalError
...
SUBROUTINE SolveRegression(CurveNum, TableType, CurveName, RawDataX, RawDataY, RawDataX2)
  ...
  USE DataGlobals,    ONLY: DisplayAdvancedReportVariables, OutputFileInits !, ShowContinueError, ShowSevereError
