...
PUBLIC          ! By definition, all variables which are placed in this data
  ...
  TYPE ControlsType
    ...
    REAL         :: TolX   = 1.0e-3           ! Relative tolerance for variable X
    REAL         :: ATolX  = 1.0e-3           ! Absolute tolerance for variable X
    REAL         :: ATolY  = 1.0e-3           ! Absolute tolerance for variable Y
  ...
  TYPE RootFinderDataType
    ...
    REAL                 :: XCandidate = 0.0       ! Candidate X value to use next when evaluating F(X)
    REAL                 :: ConvergenceRate = 0.0  ! Convergence rate achieved over the last 2 successive iterations
