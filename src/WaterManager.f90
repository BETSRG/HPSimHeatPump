...
USE DataGlobals, ONLY: MaxNameLength, BigNumber !, ShowWarningError, ShowSevereError, ShowFatalError, ShowContinueError
...
SUBROUTINE GetWaterManagerInput
  ...
  Use DataGlobals ,    ONLY: NumOfZones !, ShowSevereError
  Use DataInterfaces, ONLY: SetupOutputVariable
