...
TYPE AirLoopCompData  !data for an individual component
  ...
  REAL                      :: Capacity =0.0 ! ventilation load factor
  INTEGER                        :: OpMode = 0
...
TYPE AirLoopBranchData ! a branch is a sequence of components
  ...
  REAL                      :: MinVolFlowRate    =0.0 ! minimum flow rate for the branch (m3/s)
  REAL                      :: MaxVolFlowRate    =0.0 ! maximum flow rate for the branch (m3/s)
  REAL                      :: MinMassFlowRate   =0.0 ! minimum mass flow rate for the branch (kg/s)
  REAL                      :: MaxMassFlowRate   =0.0 ! maximum mass flow rate for the branch (kg/s)
...
TYPE :: DefinePrimaryAirSystem ! There is an array of these for each primary air system
  ...
  REAL                                         :: DesignVolFlowRate = 0.0 ! the design total supply air flow rate (m3/s)
