...
!PRIVATE GetListofSectionsinInput   !RS: This subroutine is never used
...
!PRIVATE TurnOnReportRangeCheckErrors   !RS: This subroutine is never used
!PRIVATE TurnOffReportRangeCheckErrors  !RS: This subroutine is never used
PUBLIC  GetNumRangeCheckErrorsFound

!PRIVATE GetNumObjectsInIDD !RS: This function is never used
!PRIVATE GetListOfObjectsInIDD  !RS: This function is never used
!PRIVATE GetObjectDefInIDD   !RS: This function is never used
...
SUBROUTINE ProcessInput
 ...
 USE DataOutputs,            ONLY: iNumberOfRecords,iNumberOfDefaultedFields,iTotalFieldsWithDefaults,  &
  ...
  IMPLICIT NONE    ! Enforce explicit typing of all variables in this routine
   ...
   IF (LEN_TRIM(ProgramPath) == 0) THEN     !RS: Line 76244 starts the HPSim part of the IDD
     FullName='Energy+.idd'
   ELSE
