...
!
      DO 10 I=1,50
          ...
          DELTH2=H2-H
!
          IF(ABS(DELTH2).LT.1.E-3) GOTO 20
!
...
!
	  ...
	  DIMENSION A(10),B(10)
!
      DATA A /52.26,71.1,95.5,126.68,166.08, &
             215.38,276.36,351.16,441.94,551.36/
      DATA B /611.2,517.,273.,-194.7,-982.7, &
             -2215.2,-4044.6,-6662.6,-10293.8,-15217.7/
!
      DATA C1/-5800.2206/,C2/1.3914993/,C3/-0.048640239/, &
      C4/0.41764768E-4/,C5/-0.14452093E-7/,C6/6.5459673/
!
      IT=INT(TDB/5.0) + 1
