...
!Flow:
  ...
  If (LenRatio .GT. 1.17) Then                                           
    PCR = EXP(11.5292-0.4922*(LenRatio)-1.6309*LOG(PINLET))+0.0317* &
            (LenRatio**2+0.0265*LenRatio*LOG(PINLET))
  Else
    PCR = EXP(12.2892-0.9567*LenRatio-1.7491*LOG(PINLET)+ &
            0.0937*LenRatio*LOG(PINLET))
  EndIf
